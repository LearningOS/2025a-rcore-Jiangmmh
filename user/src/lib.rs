...
#[no_mangle]
#[link_section = ".text.entry"] // 将_start编译后的汇编代码放在.text.entry代码段中
pub extern "C" fn _start(argc: usize, argv: usize) -> ! {
    ...
    // 调用main函数，并使用exit退出，将返回值告知给操作系统
    exit(main(argc, v.as_slice()));
}

#[linkage = "weak"]     // 启用弱链接特性，main优先作为bin目录下的程序的符号
#[no_mangle]            // 如果bin目录下找不到main，那就让下面这个函数使用main
